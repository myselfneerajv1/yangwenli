...
const API_GROUPS: EndpointGroup[] = [
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: 'Per-feature risk score contribution breakdown for a single contract (v5.1).',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: 'Per-feature z-score contribution breakdown for risk score (v5.1 model).',
      },
      {
        method: 'GET',
